...
import icon3 from "/src/assets/icons/icon-3.svg";
import icon4 from "/src/assets/icons/icon-4.svg";
import icon5 from "/src/assets/icons/icon-5.svg";
import icon6 from "/src/assets/icons/icon-6.svg";
import icon7 from "/src/assets/icons/icon-7.svg";
import icon8 from "/src/assets/icons/icon-8.svg";
